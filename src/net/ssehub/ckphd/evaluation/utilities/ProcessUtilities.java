...
//        private Throwable executionException;
        ...
        /**
         * Constructs a new {@link ExecutionResult} instance.
         * 
...
//        }
        ...
        /**
         * Returns the {@link #executionException}, which might have been caught during the execution of the process for
         * the {@link #command}.
         * 
...
//        }
         ...
         * <i>0</i>.
         * 
         * @return <code>true</code> if the process executing the command has exit value <i>0</i>; <code>false</code>
         *         otherwise
         */
        public boolean executionSuccessful() {
//            return processExitValue == 0 && executionException == null; ...and there were no exceptions thrown.
     ...
     * 
     * @param command the array of {@link String}s, which, in the given order, define the command that shall be
     *        executed; should never be <i>empty</i> or <code>null</code> itself as well as any of its elements
     * @param workingDirectory the {@link File} denoting the working directory of the process created by this method for
     *        executing the given command; can be <code>null</code> if the process should use the directory in which the
     *        tool is executed
     * @return the {@link ExecutionResult} of the process executing the given command or <code>null</code>, if that
     *         execution fails
     * @throws ProcessUtilitiesException if the given command is erroneous or its execution fails
     */
    public ExecutionResult executeCommand(String[] command, File workingDirectory) throws ProcessUtilitiesException {
        ...
        try {
            ...
            throw new ProcessUtilitiesException("An element of the command \"" + commandString + "\" is \"null\"", e);
        } catch (IndexOutOfBoundsException e) {
            throw new ProcessUtilitiesException("The command to execute is a empty", e);
        } catch (SecurityException e) {
            throw new ProcessUtilitiesException("An existing security manager detected an issue during the execution of"
                    + " command \"" + commandString + "\"", e);
        } catch (IOException e) {
            throw new ProcessUtilitiesException("An I/O error occured during the execution of command \""
                    + commandString + "\"", e);
        } catch (InterruptedException e) {
            throw new ProcessUtilitiesException("Waiting for the execution of command \"" + commandString 
                    + "\" interrupted", e);
        } finally {
            if (inputStream != null) {
                try {
                    ...
                    throw new ProcessUtilitiesException("Closing the input stream for reading the standard output of"
                            + " the process for command \"" + commandString + "\" failed", e);
                }
            }
            if (errorStream != null) {
                try {
                    ...
                    throw new ProcessUtilitiesException("Closing the input stream for reading the error output of"
                            + " the process for command \"" + commandString + "\" failed", e);
                }
            }
            if (process != null) {
     ...
     * 
     * @param stream the {@link InputStream} from which the data shall be read
     * @return the {@link String} representing the given stream's data or <code>null</code>, if reading the stream fails
     * @throws ProcessUtilitiesException if reading the stream data fails
     */
    public String readStream(InputStream stream) throws ProcessUtilitiesException {
        ...
        if (stream != null) {            
            ...
            try {
                ...
                throw new ProcessUtilitiesException("Reading stream data failed", e);
            } finally {
                try {
                    bufferedReader.close();
                } catch (IOException e) {
                    throw new ProcessUtilitiesException("Closing the buffered reader for reading an input stream"
                            + " failed", e);
                }
                try {
                    inputStreamReader.close();
                } catch (IOException e) {
                    throw new ProcessUtilitiesException("Closing the given input stream failed", e);
                }
            }
        }
        return streamData;
